...
unzip -np SourceCodePro.zip Sauce\ Code\ Pro\ Medium\ Nerd\ Font\ Complete.ttf > linux-medium.ttf
unzip -np SourceCodePro.zip Sauce\ Code\ Pro\ Bold\ Nerd\ Font\ Complete.ttf > linux-bold.ttf
